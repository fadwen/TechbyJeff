...
function Find-BackupFile {
    ...
    begin {
        Write-StructuredLog "Starting backup file discovery operation" -Level Debug -Component 'BackupDiscovery' -CorrelationId $CorrelationId
    }
    ...
    process {
        try {
            ...
            Write-StructuredLog "Starting backup file discovery in: $sanitizedPath" -Level Debug -Component 'BackupDiscovery' -CorrelationId $CorrelationId
            ...
            if (-not (Test-Path $sanitizedPath -PathType Container)) {
                ...
                Write-StructuredLog $errorMessage -Level Error -Component 'BackupDiscovery' -CorrelationId $CorrelationId
            ...
            Write-StructuredLog "Scanning directory for XML backup files: $sanitizedPath" -Level Verbose -Component 'BackupDiscovery' -CorrelationId $CorrelationId
            ...
            Write-StructuredLog "Found $($backupFiles.Count) XML files for analysis" -Level Verbose -Component 'BackupDiscovery' -CorrelationId $CorrelationId
                ...
                try {
                    ...
                    if ($DateRange) {
                        try {
                            ...
                            Write-StructuredLog "Failed to parse backup date for $($file.FullName): $($_.Exception.Message)" -Level Warning -Component 'BackupDiscovery' -CorrelationId $CorrelationId
                            continue
                        }
                    }
                    ...
                    $errorCount++
                    Write-StructuredLog "Failed to process backup file $($file.FullName): $($_.Exception.Message)" -Level Warning -Component 'BackupDiscovery' -CorrelationId $CorrelationId
                    continue
                }
            }
            ...
            Write-StructuredLog "Backup discovery completed" -Level Verbose -Component 'BackupDiscovery' -Details $discoveryResults -CorrelationId $CorrelationId
            ...
            Write-StructuredLog "Error during backup file discovery" -Level Error -Component 'BackupDiscovery' -Details $errorDetails -CorrelationId $CorrelationId
        ...
        Write-StructuredLog "Backup file discovery operation completed" -Level Debug -Component 'BackupDiscovery' -CorrelationId $CorrelationId
    }
}

Write-StructuredLog "Find-BackupFile module loaded successfully" -Level Debug -Component 'BackupDiscovery' -CorrelationId $([System.Guid]::NewGuid().ToString())
