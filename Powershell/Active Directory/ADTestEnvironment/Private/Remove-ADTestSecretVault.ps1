                        ...
                        if ($storeConfig) {
                            if ($Force -or $PSCmdlet.ShouldProcess("SecretStore Configuration", "Reset to no authentication")) {
                                ...
                                try {
                                    ...
                                    $defaultPassword = ConvertTo-SecureString "ADTestEnvironmentPassword" -AsPlainText -Force
                                    Reset-SecretStore -Password $defaultPassword -Authentication None -Interaction None -Force -ErrorAction Stop
