...
## Overview
This document summarizes the comprehensive memory management improvements implemented in the Find-UnknownSIDs script to address excessive memory usage during large-scale discovery operations.
...
- `Find-UnknownSIDs.ps1` - Parameter addition and cleanup integration
...
- `Find-UnknownSIDs.ps1` - Cleanup and parameter additions
...
- `Find-UnknownSIDs.ps1` - Added `-PreserveTempFiles` parameter documentation
