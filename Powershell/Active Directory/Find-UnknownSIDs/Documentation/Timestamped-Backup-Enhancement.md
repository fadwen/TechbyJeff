...
The Find-UnknownSIDs script has been enhanced to organize backup files into timestamped subfolders for better organization and auditability.
...
.\Find-UnknownSIDs.ps1 -Remove -SearchBase "OU=Users,DC=contoso,DC=com"
...
.\Find-UnknownSIDs.ps1 -Restore -SearchBase "CN=User,OU=Users,DC=contoso,DC=com" -BackupPath ".\Backup\20250702_104232"
```

### Custom Backup Path with Timestamping
```powershell
# Even with custom backup path, timestamped subfolders are created
.\Find-UnknownSIDs.ps1 -Remove -SearchBase "OU=Users,DC=contoso,DC=com" -BackupPath "C:\CustomBackups"
...
1. **Main Script Enhancement** (`Find-UnknownSIDs.ps1`):
